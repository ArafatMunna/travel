...
export const travelConfig = [
  ...
  },
  {
    ...
    to: 'rangamati',
    description:
      'A picturesque valley in the Chittagong Hill Tracts, known for its breathtaking views and serene environment. A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine. I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents.',
    videoUrl: 'https://www.youtube.com/embed/2HdpX43bm2M?rel=0',
    isAvailable: true,
  },
  {
    id: 5,
